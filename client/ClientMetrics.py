...
class Metrics:
    ...
    def implicit_yearly_rate(self, value:str) -> float:
        ...
        rate =  ( (self.object.future_price/self.object.TickerInfo[value])**(days/360) - 1) * 100
    ...
    def get_implicit_spot_rate(self) -> float:
        implicit_spot_rate = self.implicit_yearly_rate(value = "regularMarketPrice" )
        self.log.info(f'Implicit Spot Yearly rate: {implicit_spot_rate}')
        return implicit_spot_rate
